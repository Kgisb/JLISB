...
with st.sidebar:
    ...
    MASTER_SECTIONS = {
        "Performance": ["Cash-in","Dashboard","MIS","Daily Business","Sales Tracker","AC Wise Detail","Leaderboard", "Quick View", "Comparison", "Call Talk-time Report", "Pipeline", "Sales Activity", "Activity Tracker", "Deal stage", "Original source", "Referral / No-Referral"],
...
def _render_performance_referral_no_referral(
    ...
    _kpi_block("Referral generated (Deal Source=Referral)", resA["ReferralGenerated"], resB["ReferralGenerated"])
    ...
    chart_df = pd.DataFrame([
        ...
        {"Metric":"Referral generated","Window":"A (Referral)","Value":resA["ReferralGenerated"]},
    ...
    tbl = pd.DataFrame([
        {"Side":"A (Referral)",
         ...
         "Referral generated":resA["ReferralGenerated"], "Self‑generated referrals":resA["SelfGenReferrals"],
        ...
        {"Side":"B (Non‑Referral)",
         ...
         "Referral generated":resB["ReferralGenerated"], "Self‑generated referrals":resB["SelfGenReferrals"],
