...
# --- Performance / Activity tracer (explicit master gate) ---
try:
    if 'master' in globals() and master == "Performance" and 'view' in globals() and view == "Activity tracer":
        _render_performance_activity_tracer(df_f)
...
def _render_performance_activity_tracer(df_scope: pd.DataFrame):
